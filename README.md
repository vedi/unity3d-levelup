...
[unity3d-levelup v1.0.2](http://library.soom.la/fetch/unity3d-levelup/1.0.2?cf=github)  

[all-in-one package](http://library.soom.la/fetch/unity3d-allinone/1.0.0?cf=github)  
...
1. Download the following unitypackages:
    - [soomla-unity3d-core](http://library.soom.la/fetch/unity3d-core/1.0.1?cf=github)  
    - [unity3d-store](http://library.soom.la/fetch/unity3d-store/1.7.5?cf=github)  
    - [unity3d-profile](http://library.soom.la/fetch/unity3d-profile/2.0.0?cf=github)  
    - [unity3d-levelup](http://library.soom.la/fetch/unity3d-levelup/1.0.2?cf=github)  
