...
[soomla-unity3d-core v1.0.4](http://library.soom.la/fetch/unity3d-core/1.0.5?cf=github)  
[unity3d-store v1.7.13](http://library.soom.la/fetch/unity3d-store/1.7.13?cf=github)  
[unity3d-profile v2.0.6](http://library.soom.la/fetch/unity3d-profile/2.0.6?cf=github)  
[unity3d-levelup v1.0.9](http://library.soom.la/fetch/unity3d-levelup/1.0.9?cf=github)  

[all-in-one package](http://library.soom.la/fetch/unity3d-allinone/1.0.9?cf=github)  
...
1. Download the following unitypackages:
    - [soomla-unity3d-core](http://library.soom.la/fetch/unity3d-core/1.0.4?cf=github)  
    - [unity3d-store](http://library.soom.la/fetch/unity3d-store/1.7.9?cf=github)  
    - [unity3d-profile](http://library.soom.la/fetch/unity3d-profile/2.0.3?cf=github)  
    - [unity3d-levelup](http://library.soom.la/fetch/unity3d-levelup/1.0.6?cf=github)  
